...
# LD Pruning
Analysis to calculate, visualize, and perform linkage disequilibrium (LD) pruning for population structure analyses. It also converts the final list of SNPs into a matrix format for subsequent PCA analysis.
