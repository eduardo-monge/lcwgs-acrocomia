...
* [7.6.2.3. Run model a](7.6.2.3.run_model_a.sh) - With fastsimcoal2
...
* [7.6.2.8. Calculated bootstrap values on winner model](7.6.2.8.calc_boot.sh) -  With fastsimcoal2
* [7.6.2.9. Collect bootstrap results](7.6.2.3.colect_boot.sh) -  With bash 
